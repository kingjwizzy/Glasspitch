...
// Themed 404 for an unknown / untracked team slug (ARCHITECTURE.md §11). The
// page read returns null for a missing team, which triggers notFound().
  ...
  return (
    <div className="mx-auto max-w-md py-12 text-center">
      ...
      <p className="mt-3 text-sm leading-relaxed text-fg-dim">
        We don&rsquo;t have this team in our record — it may not be a tracked
        team, or the link may be out of date.
      </p>
